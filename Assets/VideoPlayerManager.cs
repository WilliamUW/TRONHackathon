...
public class VideoClipChanger : MonoBehaviour
{
    ...
    public async void TalkToGemini(string userResponse)
    {
        Debug.Log("TalkToGemini called with: " + userResponse);
        ...
        using (HttpClient client = new HttpClient())
        {
            ...
            var conversationJson = JsonConvert.SerializeObject(new { contents = conversation }, Formatting.None);
                ...
                conversation.Add(new Dictionary<string, object>
                    {
                        ...
                        { "parts", new List<object>
                            {
                                new { text = "Extracted model response goes here" }
                            }
                        }
                    });
